...
// ============================================================
// TAMU ROUTES — semua user yang login (role 'tamu')
// ============================================================
Route::middleware(['auth'])->prefix('tamu')->name('tamu.')->group(function () {

    Route::get('/dashboard', function () {
        // Pastikan hanya role tamu
        if (auth()->user()->role !== 'tamu') {
            abort(403);
        }
        return view('tamu.dashboard'); // buat view ini sesuai kebutuhan
    })->name('dashboard');

});

// ============================================================
// SISWA DASHBOARD — alias untuk redirect setelah login
// ============================================================
